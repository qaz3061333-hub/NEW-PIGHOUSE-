...
本段是 PR #46「Archive Schema Planning v1」之後的文件審查整理。本次只是 review，不是 migration；本次沒有改 Supabase schema、沒有新增 table、沒有新增 migration、沒有做 cron、沒有做 Edge Function、沒有刪資料、沒有接 LINE、沒有寫 Supabase `messages`、沒有處理 PR #7。
