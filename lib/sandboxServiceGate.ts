...
export function evaluateSandboxServiceGate(message: string): SandboxGateDecision {
  ...
  const outOfScopeKeywords = [
    ...
    "法律", "訴訟", "政治", "宗教", "優惠碼", "折扣碼", "比較別家", "其他店家", "寫作文", "算數學", "產生圖片",
    "畫圖", "ai", "chatgpt", "gemini",
  ];

  const manualKeywords = [
    "真人", "人工", "店長", "主管", "不要機器人", "叫人", "找人", "投訴", "客訴", "我很生氣", "退款", "退費", "價格爭議", "太貴",
    "受傷", "流血", "流膿", "化膿", "嚴重紅腫", "紅腫很嚴重", "疑似感染", "醫生", "急診", "診斷", "醫療診斷", "指名", "指定某員工",
  ];

  const abnormalKeywords = ["紅腫", "過敏", "受傷", "流血", "流膿", "化膿", "抓傷", "發炎", "異常", "疼痛", "一直叫", "不舒服"];
  const appointmentKeywords = ["預約", "想約", "改時間", "改約", "明天還有空", "下週", "幾點可以", "有空嗎", "時段", "排時間"];
  const knowledgeKeywords = [
    "營業時間", "付款", "接送", "規範", "服務範圍", "注意事項", "住宿", "照護", "流程",
    "多少", "費用", "收費", "價錢", "報價", "價格", "價位", "多少錢",
    "加購", "單項", "服務", "方案", "包月",
    "洗澡", "美容", "大美容", "修毛", "剪指甲", "磨指甲", "清耳", "耳朵清潔",
  ];
